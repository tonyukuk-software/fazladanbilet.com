...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Orders.user_url_for_btc_send'
        db.add_column(u'member_orders', 'user_url_for_btc_send',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=27, null=True),
                      keep_default=False)


        # Changing field 'Orders.cargo_no'
        db.alter_column(u'member_orders', 'cargo_no', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Orders.name'
        db.alter_column(u'member_orders', 'name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Orders.phone'
        db.alter_column(u'member_orders', 'phone', self.gf('django.db.models.fields.CharField')(max_length=11, null=True))

        # Changing field 'Orders.adress'
        db.alter_column(u'member_orders', 'adress', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Orders.cargo_company'
        db.alter_column(u'member_orders', 'cargo_company', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Orders.user_url_for_btc_send'
        db.delete_column(u'member_orders', 'user_url_for_btc_send')


        # Changing field 'Orders.cargo_no'
        db.alter_column(u'member_orders', 'cargo_no', self.gf('django.db.models.fields.CharField')(default=0, max_length=256))

        # Changing field 'Orders.name'
        db.alter_column(u'member_orders', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Orders.phone'
        db.alter_column(u'member_orders', 'phone', self.gf('django.db.models.fields.CharField')(max_length=11))

        # Changing field 'Orders.adress'
        db.alter_column(u'member_orders', 'adress', self.gf('django.db.models.fields.CharField')(max_length=256))
    ...
    models = {
        ...
        u'member.orders': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'adress': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '256', 'null': 'True'}),
