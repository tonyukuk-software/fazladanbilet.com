...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.profile_photo'
        db.add_column(u'member_member', 'profile_photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.profile_photo'
        db.delete_column(u'member_member', 'profile_photo')
    ...
    models = {
        ...
        u'member.member': {
            ...
            'profile_photo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True'}),
