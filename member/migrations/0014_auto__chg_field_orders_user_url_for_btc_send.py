...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Orders.user_url_for_btc_send'
        db.alter_column(u'member_orders', 'user_url_for_btc_send', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Orders.user_url_for_btc_send'
        db.alter_column(u'member_orders', 'user_url_for_btc_send', self.gf('django.db.models.fields.CharField')(max_length=27, null=True))
    ...
    models = {
        ...
        u'member.orders': {
            ...
            'cargo_company': ('django.db.models.fields.CharField', [], {'default': "'3'", 'max_length': '1', 'null': 'True'}),
            ...
            'user_url_for_btc_send': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'null': 'True'})
        }
    }
